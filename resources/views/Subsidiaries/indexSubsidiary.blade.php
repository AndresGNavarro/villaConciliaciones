                    ...
                    <div class="card-header border-0">
                        <div class="row align-items-center">
                            ...
                            <div class="col text-right">
                                <a href="{{ url('/subsidiary/create')}}" class="btn btn-sm btn-success">Agregar</a>
                            </div>
                        </div>
                    </div>
                            ...
                            @foreach($objSubsidiary as $row)
                                <tr>
                                    ...
                                    <td class="text-center">
                                        <form action="{{ url('/subsidiary/'.$row->pkSubsidiary) }}" method="post">
                                        @csrf
                                        @method('DELETE')

                                        <a href="{{ url('/subsidiary/'.$row->pkSubsidiary.'/edit') }}" class="btn btn-sm btn-primary">Editar</a>
